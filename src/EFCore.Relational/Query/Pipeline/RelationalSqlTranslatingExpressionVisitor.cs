...
namespace Microsoft.EntityFrameworkCore.Relational.Query.Pipeline
{
    public class RelationalSqlTranslatingExpressionVisitor : ExpressionVisitor
    {
        ...
        private Expression ConvertAnonymousObjectComparison(BinaryExpression binaryExpression)
        {
            ...
            return leftExpressions.Zip(
                ...
                (l, r) =>
                {
                    ...
                    return Expression.MakeBinary(binaryExpression.NodeType, l, r);
                })
        ...
        protected override Expression VisitBinary(BinaryExpression binaryExpression)
        {
            ...
            {
                return Visit(ConvertAnonymousObjectComparison(binaryExpression));
            }
